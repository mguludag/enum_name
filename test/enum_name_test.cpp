...
TEST_CASE("testing the enum name deserialization") {
    ...
    CHECK(mgutility::to_enum<color>("yellow_green").value() == color::yellow_green);
    CHECK(mgutility::to_enum<color>("steel_blue").value() == color::steel_blue);
    CHECK(mgutility::to_enum<color>( "pale_turquoise").value() == color::pale_turquoise);
    CHECK(mgutility::to_enum<color>("white_smoke").value() == color::white_smoke);
    CHECK(mgutility::to_enum<color>("light_golden_rod_yellow").value() == color::light_golden_rod_yellow);
    CHECK(mgutility::to_enum<color>("dark_olive_green").value() == color::dark_olive_green);
    ...
    CHECK(mgutility::to_enum<color>("spring_green").value() == color::spring_green);
    CHECK(mgutility::to_enum<color>("rebecca_purple").value() == color::rebecca_purple);
    ...
    CHECK(mgutility::to_enum<color>("cornflower_blue").value() == color::cornflower_blue);
